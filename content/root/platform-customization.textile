...
These use Ably's existing wildcard certificate, which supports @*realtime.ably.acme.com@:
...
const ably = new Ably.Realtime({
  ...
  ... // additional Client Options such as authentication, logging, etc.
});
```
...
Now that you have tested your custom endpoints, you must modify your code to instantiate the Ably client with the provided "@ClientOptions@":/api/rest-sdk#client-options.
